...
SORT_DLL int SORT_DECL compare_int(const void *p, const void *q)
{
    return (*(int *)p) - (*(int *)q);
}
...
SORT_DLL void SORT_DECL mysort(void *base, size_t nmemb, size_t size, int (*compar)(const void*, const void*))
{
